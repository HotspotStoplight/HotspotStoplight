...
geojson_file <- "/Users/oliveratwood/Box Sync/Hotspot Stoplight Data/CR_Crop4.geojson"
geo_data <- st_read(geojson_file)

# # Assuming you want the first polygon (adjust as needed)
# polygon <- geo_data[1, ]
...
# If you need only the first and last point as in your example format
