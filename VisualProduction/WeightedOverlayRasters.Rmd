...
Climate_Impact_Risk_v2 <- norm(raster_list$population * Climate_Hazards)
...
writeRaster(Bio_Loss_Risk_Q4, "Bio_Loss_Risk_Q4.tif", overwrite=TRUE)
writeRaster(Climate_Impact_Risk_Q4, "Climate_Impact_Risk_Q4.tif", overwrite=TRUE)
