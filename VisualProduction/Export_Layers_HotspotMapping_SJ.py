...
docPath = r"C:\Users\olive\Box Sync\Hotspot Stoplight Resources\Maps\Working\SanJose"


lyt = aprx.listLayouts("SanJose")[0]
...
lyt = aprx.listLayouts("SanJose_10x")[0]
...
lyrList = m.listLayers("TreeLoss_Mosaic_Crop2")
for lyr in lyrList:   
   lyr.visible = True
