...
writeRaster(BII, filename = "BiodiversityIntactness_2020.tif", format = "GTiff", overwrite=TRUE)
writeRaster(LC_Vul_Clark, filename = "Land_Cover_Vulnerability.tif", format = "GTiff", overwrite=TRUE)
```
