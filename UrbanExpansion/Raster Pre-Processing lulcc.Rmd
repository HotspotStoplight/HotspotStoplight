...
# WDPA
url <- "https://github.com/HotspotStoplight/HotspotStoplight/raw/main/UrbanExpansion/data/wdpa.tif"
temp <- tempfile(fileext = ".tif")
download.file(url, temp, method = "auto")
wdpa <- raster(temp)
...
writeRaster(BII, filename = "BiodiversityIntactnessIndex_2020.tif", format = "GTiff", overwrite=TRUE)
writeRaster(LC_Vul_Clark, filename = "Land_Cover_Change_Probs.tif", format = "GTiff", overwrite=TRUE)
