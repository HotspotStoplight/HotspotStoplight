...
prox_road <- projectRaster(prox_road, crs = coordinate_system, method = "average")
...
# Assign names to non-land cover rasters
names(prox_road) <- "prox_road"
names(prox_highway) <- "prox_highway"
names(pop2010) <- "pop2010"
...
prox_urban <- urban[urban > 0] <- 1
# Replace all zero values with NA
prox_urban[prox_urban == 0] <- NA
...
```{r}
# Usage
theRasterNamesList <- c("urban", "forest", "crop", "water", "prox_road", "prox_highway", "prox_urban", "pop2010", "slope", "wdpa")
