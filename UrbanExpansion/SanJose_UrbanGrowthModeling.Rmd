...
pop2010 <- projectRaster(pop2010, crs = coordinate_system)

pop2020 = raster('/Users/oliveratwood/Documents/GitHub/HotspotStoplight/UrbanExpansion/data/Pop_2020_Crop4.tif')
pop2020 <- projectRaster(pop2020, crs = coordinate_system)

slope = raster('/Users/oliveratwood/Documents/GitHub/HotspotStoplight/UrbanExpansion/data/Slope.tif')
slope <- projectRaster(slope, crs = coordinate_system)

wdpa = raster('/Users/oliveratwood/Documents/GitHub/HotspotStoplight/UrbanExpansion/data/wdpa.tif')
wdpa <- projectRaster(wdpa, crs = coordinate_system)

# Clip the rasters with the polygon
lc_2013 <- mask(lc_2013, cropbox)
lc_2023 <- mask(lc_2023, cropbox)
pop2010 <- mask(pop2010, cropbox)
pop2020 <- mask(pop2020, cropbox)
slope <- mask(slope, cropbox)
wdpa <- mask(wdpa, cropbox)

# Project the rasters to the correct coordinate system
...
# Usage
theRasterNamesList <- c("urban", "forest", "crop", "water")
